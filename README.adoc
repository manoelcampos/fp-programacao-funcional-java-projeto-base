...
- [Soma do dobro dos números pares](https://github.com/manoelcampos/fp-aula-01-soma-dobro-pares-js)

=== Aula 02 (projeto externo)

- [Praticando Imutabilidade em Java](https://github.com/manoelcampos/fp-aula-02-imutabilidade-java)
...
- [Um projeto base em OpenJFX para desenhar polígonos na tela e permitir a implementação de algumas funções para descobrir o tipo de cada polígono e calcular seu perímetro usando Stream.map e Stream.flatMap](https://github.com/manoelcampos/fp-projeto-1-poligonos-flatmap)
